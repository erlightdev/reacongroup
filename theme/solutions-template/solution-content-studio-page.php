...
<main id="primary" class="overflow-x-hidden bg-background" role="main">
	<?php if ($show_hero): ?>
		...
		<section
			...
			<div class="reacon-about-hero-card relative min-h-[255px] overflow-hidden rounded md:rounded-[24px] bg-[#062B53] sm:min-h-[300px] lg:min-h-[380px] lg:rounded-[31px]">
				<?php if ($hero_bg_url): ?>
					<img
	...
	<?php if ($show_cta): ?>
		...
		<section
			...
			<div class="mx-auto w-full  px-4 sm:px-6 lg:px-8">
				<div
					class="relative overflow-hidden rounded-[22px] px-5 py-10 sm:px-8 sm:py-10 lg:rounded-[24px] lg:px-12"
						...
						<div class="mt-8 flex w-full flex-col items-center justify-center gap-3 sm:mt-9 sm:w-auto sm:flex-row sm:gap-2.5 md:mt-10">
							<?php if (!empty($cta_primary_btn)): ?>
								...
								<a
									...
									class="group inline-flex w-full items-center justify-between gap-2.5 rounded-full bg-white py-1 pl-5 pr-1 font-sans text-base font-medium text-[#0B6A74] no-underline transition-all duration-300 hover:bg-white/90 sm:w-auto">
