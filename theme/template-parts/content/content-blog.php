		...
		<div class="mx-auto w-full max-w-[1440px] px-4 sm:px-6 lg:px-8 xl:px-10 2xl:px-12">
			<div class="mx-auto flex w-full max-w-[1280px] flex-col items-start gap-6 sm:gap-8 lg:gap-10">
				...
				<section
					...
					class="w-full pt-10 sm:pt-14 lg:pt-20 xl:pt-[120px]">
					<div class="w-full">
							...
							<?php foreach ($explore_cards as $card): ?>
								<article class="swiper-slide bg-white border border-border rounded-[32px] p-[10px] flex flex-col gap-[24px] overflow-hidden min-h-[420px]">
									...
									<a
										...
										class="self-end w-fit border border-border rounded-[24px] px-[16px] mt-2 py-[8px] flex items-center justify-end transition-colors hover:border-primary no-underline">
