...
<header
	...
	role="banner"
>
	<div class="mx-auto sticky flex max-w-7xl items-center justify-between px-6 py-5 lg:px-12">
		...
		>
			<ul class="flex items-center gap-1 rounded-full border border-white/20 bg-white/10 px-1.5 py-1 backdrop-blur-md">
							...
							<div class="overflow-hidden rounded-3xl border border-border/60 bg-white shadow-xl">
								<div class="grid grid-cols-[1fr_280px]">
									...
									<div class="relative overflow-hidden">
										<img
											src="<?php echo esc_url( get_template_directory_uri() . '/public/image/mega-menu-feature.jpg' ); ?>"
		...
		<div class="hidden items-center gap-3 lg:flex">
			<a
				...
				class="rounded-full bg-foreground px-5 py-2.5 font-display text-sm font-bold text-white no-underline transition-all duration-200 hover:-translate-y-px hover:bg-foreground/90"
			>
			...
			<a
				...
				class="inline-flex items-center gap-2 rounded-full bg-primary py-2.5 pl-5 pr-2.5 font-display text-sm font-bold text-white no-underline transition-all duration-200 hover:-translate-y-px hover:brightness-110"
			>
