...
<section id="reacon-cta-section" class="relative m-1.5 overflow-hidden rounded-[22px] bg-[#0d5959] sm:m-2 lg:m-4 lg:rounded-[31px]">
	<div class="pointer-events-none absolute inset-0 z-0" aria-hidden="true">
		<svg preserveAspectRatio="none" style="display:block; width:100%; height:100%;" viewBox="0 0 2014 746" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M0 0 L0 285 L270 530 L960 0 Z" fill="url(#about-cta-left)" fill-opacity="0.5" />
			<path d="M2014 0 L2014 290 L1520 746 L980 746 L1590 0 Z" fill="url(#about-cta-right)" fill-opacity="0.36" />
			<defs>
				<linearGradient id="about-cta-left" x1="0" y1="0" x2="1000" y2="560" gradientUnits="userSpaceOnUse">
					<stop offset="0" stop-color="#1ECAD3" stop-opacity="0.68" />
					<stop offset="1" stop-color="#1ECAD3" stop-opacity="0.02" />
				</linearGradient>
				<linearGradient id="about-cta-right" x1="2014" y1="0" x2="980" y2="746" gradientUnits="userSpaceOnUse">
